...
- Backward pass: chain rule to caculate the derivatives
...
def draw_dot(root):
    ...
    for n in nodes:
        ...
        # for any value in teh graph create a rectangular record
        dot.name(name = uid, label = "{ data %.4f }" % (n.data, ), shape='record')
        if n._op:
